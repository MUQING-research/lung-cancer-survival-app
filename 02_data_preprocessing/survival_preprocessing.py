# Module guide:
# - Role: Run leakage-safe survival preprocessing.
# - Workflow: Build the event-time target, split the cohort, and fit preprocessing from the training partition.
# - Design note: Keep imputation, encoding, and scaling parameters tied to the training data.
